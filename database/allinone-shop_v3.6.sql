...
START TRANSACTION;
USE `zabuzachaule`;
INSERT INTO `zabuzachaule`.`user` (`id`, `shop_id`, `name`, `email`, `phone_number`, `username`, `password`, `confirmcode`, `status`, `start_date`, `end_date`, `description`, `salary_by_hour`, `work_from`, `work_to`) VALUES (1, 1, 'Trần Trí Duệ', 'trantridue@gmail.com', '0979355285', 'admin', '4eae18cf9e54a0f62b44176d074cbe2f', 'y', 'y', '2014-01-01 10:00:00', '2020-12-31 22:00:00', 'Ông chủ', 8000, 8, 21);
...
-- -----------------------------------------------------
-- Data for table `zabuzachaule`.`fund`
-- -----------------------------------------------------
START TRANSACTION;
USE `zabuzachaule`;
INSERT INTO `zabuzachaule`.`fund` (`id`, `name`, `description`) VALUES (1, 'KÉT SẮT', 'KÉT SẮT');
