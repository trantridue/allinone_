...
CREATE INDEX `fk_user_absent_user1_idx` ON `zabuzachaule`.`user_absent` (`user_id` ASC);


-- -----------------------------------------------------
-- Table `zabuzachaule`.`user_salary`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `zabuzachaule`.`user_salary` ;

CREATE TABLE IF NOT EXISTS `zabuzachaule`.`user_salary` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `user_id` INT NOT NULL,
  `date` DATETIME NOT NULL,
...
CREATE INDEX `fk_user_salary_table_user1_idx` ON `zabuzachaule`.`user_salary` (`user_id` ASC);
...
START TRANSACTION;
USE `zabuzachaule`;
INSERT INTO `zabuzachaule`.`user` (`id`, `shop_id`, `name`, `email`, `phone_number`, `username`, `password`, `confirmcode`, `status`, `start_date`, `end_date`, `description`, `salary_by_hour`, `work_from`, `work_to`) VALUES (1, 1, 'Trần Trí Duệ', 'trantridue@gmail.com', '0979355285', 'admin', 'ea89fe25edf05960003a3b1ab4f4366e', 'y', 'y', '2014-01-01 10:00:00', '2020-12-31 22:00:00', 'Ông chủ', NULL, NULL, NULL);
INSERT INTO `zabuzachaule`.`user` (`id`, `shop_id`, `name`, `email`, `phone_number`, `username`, `password`, `confirmcode`, `status`, `start_date`, `end_date`, `description`, `salary_by_hour`, `work_from`, `work_to`) VALUES (2, 2, 'Lê Thị Châu', 'zabuza.vn@gmail.com', '0966807709', 'chau', 'ea89fe25edf05960003a3b1ab4f4366e', 'y', 'y', '2014-01-01 10:00:00', '2020-12-31 22:00:00', 'Bà Chủ', NULL, NULL, NULL);
INSERT INTO `zabuzachaule`.`user` (`id`, `shop_id`, `name`, `email`, `phone_number`, `username`, `password`, `confirmcode`, `status`, `start_date`, `end_date`, `description`, `salary_by_hour`, `work_from`, `work_to`) VALUES (3, 1, 'Lê Thị Bảo', 'baobao170491@gmail.com', '01649785255', 'bao', 'ea89fe25edf05960003a3b1ab4f4366e', 'y', 'y', '2014-01-01 10:00:00', '2020-12-31 22:00:00', 'Nhân Viên', NULL, NULL, NULL);
