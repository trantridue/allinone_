...
START TRANSACTION;
USE `allinone`;
INSERT INTO `allinone`.`product` (`code`, `name`, `category_id`, `season_id`, `sex_id`, `export_price`, `description`, `brand_id`) VALUES ('0001', 'Áo nam', 1, 1, 1, 1000, 'Helo', 1);
INSERT INTO `allinone`.`product` (`code`, `name`, `category_id`, `season_id`, `sex_id`, `export_price`, `description`, `brand_id`) VALUES ('0002', 'Quần jean', 2, 2, 2, 400, 'Tốt', 2);
