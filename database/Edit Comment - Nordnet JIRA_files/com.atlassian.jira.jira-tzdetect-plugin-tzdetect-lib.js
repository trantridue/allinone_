...
JIRA.plugins.tzdetect.soy.banner = function(opt_data, opt_sb) {
  ...
  output.append(soy.$$escapeHtml(opt_data.message), '<p><a class="tz-yes" href="', soy.$$escapeHtml(opt_data.updateLink), '">', soy.$$escapeHtml(opt_data.updateLinkText), '</a></p>');
...
JIRA.plugins.tzdetect.soy.dropdown = function(opt_data, opt_sb) {
  ...
  for (var sectionIndex17 = 0; sectionIndex17 < sectionListLen17; sectionIndex17++) {
    ...
    if (sectionData17.region) {
      output.append('<strong>', soy.$$escapeHtml(sectionData17.region), '</strong><ul class="aui-list-truncate">');
      ...
      for (var zoneIndex24 = 0; zoneIndex24 < zoneListLen24; zoneIndex24++) {
        ...
        output.append('<li><a href="', soy.$$escapeHtml(opt_data.baseHref), '#zone-', soy.$$escapeHtml(zoneData24.timeZoneId), '" data-tzid="', soy.$$escapeHtml(zoneData24.timeZoneId), '">', soy.$$escapeHtml(zoneData24.gmtOffset), ' ', soy.$$escapeHtml(zoneData24.city), '</a></li>');
      }
      output.append('</ul>');
    } else if (sectionData17.other) {
      output.append('<ul class="aui-list-truncate"><li><a href="', soy.$$escapeHtml(opt_data.baseHref), '#zone-other" data-tzother="true">', soy.$$escapeHtml(sectionData17.other), '</a></li></ul>');
    }
    output.append('</div>');
  }
  output.append('</div>');
