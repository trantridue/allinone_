...
<tr style="color: blue;">
	...
	<td><input type="text" maxlength="6" id="give_customer" size="3" autocomplete="off"  onclick="this.select();" onkeypress="validateNum(event);" value="0" style="text-align: center;"/></td>
</tr>
<tr height="30px">
