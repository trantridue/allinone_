...
<td <?php $commonService->displayColor('#F5FFC4','black');?>>ROTD : <?php echo $reportService->getRoiByShopAndDate($td,$td,'all');?></td>
<td <?php $commonService->displayColor('yellow','black');?>>ROM : <?php echo $reportService->getRoiByShopAndDate(date('Y-m-01'),date('Y-m-t'),'all');?></td>
