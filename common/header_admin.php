...
<td <?php $commonService->displayColor('#E20C14','white');?>>ETD : <?php $t=$reportService->getAmountToDay(); echo $t; ?></td>
...
<?php if ($commonService->isMobile ()) {?> <span class="exportclass"> <?php echo $t;?> </span> <?php }?>
