...
<input type="hidden" id="id_histo_fund" value="<?php echo $_REQUEST['id'];?>"/>
	<tr>
		...
		<td><?php
		$commonService->printDropDownListFromTableSelected( 'fund', 'add_fund',$_REQUEST['fund_id']);
		?>
		<input type="text" class="datefield" id="add_date" value="<?php echo date('Y-m-d',strtotime($_REQUEST['date']));?>"/>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
		<input type="text" size="4" maxlength="12" autocomplete="off" onkeypress="validateFloat(event)" id="add_amount" value="<?php echo $_REQUEST['amount'];?>">
		<input type="text" size="3" maxlength="8" autocomplete="off" onkeypress="validateFloat(event)" id="add_ratio" value="<?php echo $_REQUEST['ratio'];?>">
		</td>
	</tr>
	<tr>
		<td align="right">Description :</td>
		<td><textarea rows="3" cols="40" id="add_description"><?php echo $_REQUEST['description'];?></textarea> </td>
	</tr>
	<tr>
		<td align="right"></td>
		<td>
