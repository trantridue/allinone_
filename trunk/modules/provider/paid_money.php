...
<table class="searchcriteriatable">
	...
	<tr align="center">
		...
		?></td>
		<td><input type="text" id="paid_amount_1"  onkeypress="validateFloat(event);" size="6" maxlength="8" value="0" onkeyup="calculateProviderPaid();"/></td>
		<td><input type="text" id="paid_remaining"  onkeypress="validateNon(event);" value="<?php echo $_REQUEST ['remain'];?>"/></td>
		<td rowspan="3"><textarea rows="4" cols="60" id="paid_description"></textarea> </td>
	</tr>
	<tr align="center">
		<td colspan="3">
		</td>
	...
	<tr align="center">
		...
		?></td>
		<td><input type="text" id="paid_amount_3" onkeypress="validateFloat(event);" size="6" maxlength="8" value="0"  onkeyup="calculateProviderPaid();"/></td>
	</tr>
</table>
</form>