...
CREATE INDEX `fk_export_facture_user1_idx` ON `allinone`.`export_facture` (`user_id` ASC);
...
-- -----------------------------------------------------
-- Table `allinone`.`customer_paid`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `allinone`.`customer_paid` ;

CREATE TABLE IF NOT EXISTS `allinone`.`customer_paid` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `customer_id` INT NOT NULL,
  `amount` FLOAT NOT NULL,
  `date` DATETIME NULL,
  ...
  CONSTRAINT `fk_customer_paid_customer1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_customer_debt_shop1`
    FOREIGN KEY (`shop_id`)
    REFERENCES `allinone`.`shop` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE INDEX `fk_customer_paid_customer1_idx` ON `allinone`.`customer_paid` (`customer_id` ASC);

CREATE INDEX `fk_customer_debt_shop1_idx` ON `allinone`.`customer_paid` (`shop_id` ASC);
...
CREATE INDEX `fk_export_facture_trace_shop1_idx` ON `allinone`.`export_facture_trace` (`shop_id` ASC);

CREATE INDEX `fk_export_facture_trace_customer1_idx` ON `allinone`.`export_facture_trace` (`customer_id` ASC);
...
-- -----------------------------------------------------
-- Table `allinone`.`configuration`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `allinone`.`configuration` ;

CREATE TABLE IF NOT EXISTS `allinone`.`configuration` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  `value` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`))
...
START TRANSACTION;
USE `allinone`;
INSERT INTO `allinone`.`customer` (`id`, `name`, `tel`, `description`, `date`, `created_date`, `isboss`) VALUES (1, 'Nhung HP', '0978663996', 'Thân', '2015-01-07 10:10:10', NULL, NULL);
INSERT INTO `allinone`.`customer` (`id`, `name`, `tel`, `description`, `date`, `created_date`, `isboss`) VALUES (2, 'Huong', '0978663993', 'Quen', '2015-01-07 10:11:11', NULL, NULL);
