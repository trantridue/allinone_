...
CREATE TABLE IF NOT EXISTS `allinone`.`fund` (
  ...
  `name` VARCHAR(45) NOT NULL,
  `description` VARCHAR(255) NULL,
  `in_ratio` FLOAT NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `allinone`.`fund_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `allinone`.`fund_category` ;

CREATE TABLE IF NOT EXISTS `allinone`.`fund_category` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `allinone`.`fund_change_histo` (
  ...
  `date` DATETIME NOT NULL,
  `description` VARCHAR(245) NULL,
  `ex_ratio` FLOAT NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_fund_change_histo_fund1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_fund_change_histo_fund_change_category1`
    FOREIGN KEY (`fund_category_id`)
    REFERENCES `allinone`.`fund_category` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE INDEX `fk_fund_change_histo_fund_change_category1_idx` ON `allinone`.`fund_change_histo` (`fund_category_id` ASC);
