...
START TRANSACTION;
USE `allinone`;
INSERT INTO `allinone`.`customer` (`id`, `name`, `tel`, `description`, `date`, `created_date`) VALUES (1, 'Nhung HP', '0978663996', 'Thân', '2015-01-07 10:10:10', NULL);
INSERT INTO `allinone`.`customer` (`id`, `name`, `tel`, `description`, `date`, `created_date`) VALUES (2, 'Huong', '0978663993', 'Quen', '2015-01-07 10:11:11', NULL);
